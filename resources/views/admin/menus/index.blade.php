            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>All Menus</h5>
                        <a href="{{ route('admin.menus.create') }}" class="btn btn-primary m-2">Add</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-item-center g-2">
                                                @can('menu list')
                                                    <a href="{{ route('admin.menu.items.index', $menu) }}" title="Menu Items" class="">
                                                        <i class="fas fa-list text-primary mx-2"></i>
                                                    </a>
                                                @endcan

                                                {{-- @can('menu list')
                                                    <a href="{{ route('admin.menus.show', $menu) }}" class="">
